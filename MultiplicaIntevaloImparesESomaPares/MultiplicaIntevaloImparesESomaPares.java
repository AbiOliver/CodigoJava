capackage lista3ex21;
import java.util.Scanner;

public class Lista3Ex21 {
    ...
    public static void main(String[] args) {
        ...
        //processamento
        for(int i = numero1; i<=numero2; i++){// o valor de i recebe o numero1, verificará se os os valores dos intervalos dos numeros digitados são pares ou impares e irão efetuar o cálculo pedido para cada condição.
            if(i%2==0){
                somaPares+=i;
            }else if(i%2!=0){
                multiplicaImpares*=i;
