package com.mycompany.lista1ex52;
import java.util.Scanner;
public class Lista1Ex52 {
    ...
    public static void main(String[] args) {
        ...
        double recebe1 = premio*apostador1;//Cálculo do valor  a receber multiplicando o premio pela procentagem do 1ª investimento.
        double recebe2 = premio*apostador2;//Cálculo do valor  a receber multiplicando o premio pela procentagem do 2ª investimento.
        double recebe3 = premio*apostador3;//Cálculo do valor  a receber multiplicando o premio pela procentagem do 3ª investimento.
